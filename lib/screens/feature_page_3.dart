// Path: lib/screens/feature_page_3.dart
...
class feature_page_3 extends StatelessWidget {
  @override
              ...
              child: Center(
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 10),
                    Text(
                      "Purchase at your own leisure, at home, at the beach, in the office, anywhere.",
                      textAlign: TextAlign.center,
                      style: TextStyle(
                        fontSize: 16,
                        color: Color(0xFF28254C),
                            ...
                            children: List.generate(4, (index) {
                              return Container(
                                ...
                                decoration: BoxDecoration(
                                  color: index == 2 ? Color(0xFF28254C) : Colors.grey,
